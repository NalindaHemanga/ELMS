...
<body>
  ...
  ob_start();
          ...
          <tr class=\"alt\"><td style=\"color:black;font-size:110%;\">".$_SESSION["des"]."</td><td>Posted date: ".$_SESSION["pst_date"]." </td></tr>
          </tbody>
          </table></div>"
...
echo "
  <tbody><tr><td style=\"max-width: 250px; overflow: hidden; text-overflow: ellipsis; white-space: normal;\"><p style=\"width:230px;word-wrap: break-word;
   width: 800px;color:black;\">$reply</p></td><td>$reply_pst_date</td><td> $reply_pst_usr</td></tr>
  <tr class=\"alt\">
  </tr>
  </tbody>";
  }
